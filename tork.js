 var
  ...
  type_right_brace = 0x7d,
  type_left_paren = 0x28,
  type_right_paren = 0x29,
  type_left_bracket = 0x5b,
  type_right_bracket = 0x5d,
  type_not = 0x21,
  type_not_equal = slot++,
  type_xor = 0x5e,
